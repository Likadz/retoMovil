...
import 'package:peliculas/src/models/rutaUsuario.dart';

class RankingApiPage extends StatelessWidget{
    ...
    FutureBuilder<List<dynamic>>(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        ...
        if(snapshot.hasData){//si hay datos
          ...
          List<dynamic> ld;
          for(int i = 0; i<10;i++){
            usuarios[i]=RutaUsuario(i.toString(), snapshot.data[i]['puntuacion']);//creamos el candidato*/
