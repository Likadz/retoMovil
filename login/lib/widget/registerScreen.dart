...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  TextEditingController controllerErrores = TextEditingController(text: "Errores");
  ...
  Widget crearBRegistro(){
    return Container(
      ...
      child: RaisedButton(
        elevation: 5.0,
        onPressed: () {
          if (controllerUsuario.text=="" || controllerContrasena.text=="" || controllerContrasenaRepetida.text=="" || controllerNombre.text=="" || controllerApellidos.text==""){
            controllerErrores.text = "Rellena todos los huecos";
            esVisible = true;
          } else if (controllerContrasena.text != controllerContrasenaRepetida.text){
            controllerErrores.text = "Las contraseñas no coinciden";
            esVisible = true;
          } else{
            esVisible = false;
            print("Nombre ${controllerUsuario.text}, Contraseña ${controllerContrasena.text}, Contraseña ${controllerContrasenaRepetida.text}");
  ...
  Widget crearLError() {
    return Visibility(
      visible: esVisible,
      child: Container(
        child: Text(controllerErrores.text,
          style: TextStyle(
            color: Colors.red,
            fontSize: 20.0
          ),
