...
import 'package:login/widget/loginCorrect.dart';
import 'package:login/widget/registerScreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget crearLRegistro(){
    return GestureDetector(
      onTap: () => {
        Navigator.of(context).push(_goRegister())
      },
      child: RichText(
        text: TextSpan(
          children: [
  ...
  Route _goLogueado(){
    return PageRouteBuilder(
      pageBuilder: (context, animation, secondaryAnimation) => LoginCorrect(usuario : controllerUsuario.text),
      transitionsBuilder: (context, animation, secondaryAnimation, child) {
        return child;
      },
    );
  ...
  bool existeUsuario() {
    ...
    for(var user in lista){
      if(controllerUsuario.text == user['usuario'] && controllerContrasena.text == user['contrasena']){
        existe = true;
        break;
      }
    }
